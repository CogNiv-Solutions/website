            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.25rem] border border-[#0b0b0c]/10 bg-[#f4f5f5] p-6 md:p-7">
                ...
                <p className="mt-3 flex items-baseline gap-2">
                  <span className="font-mono text-[2rem] font-bold leading-none tracking-tight">₹1,499</span>
              ...
              <div className="rounded-[1.25rem] border border-[#0b0b0c]/10 bg-[#f4f5f5] p-6 md:p-7">
                ...
                <p className="mt-3 flex items-baseline gap-2">
                  <span className="font-mono text-[2rem] font-bold leading-none tracking-tight">₹2,999</span>
                  <span className="font-mono text-[12px] text-[#5f6368]">/month onwards</span>
                </p>
                <ul className="mt-4 space-y-2">
