      ...
      <main id="main" className="pt-24 pb-20 md:pt-32 md:pb-28">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[13px] font-mono text-[#0b0b0c]/50">
            ...
            <span className="text-[#0b0b0c] font-medium">Automation Services</span>
          </nav>
        </div>
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-20 md:mb-28">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href="/audit"
                className="btn-press group inline-flex items-center gap-2 rounded-full bg-[#0b0b0c] px-6 py-3.5 text-[14.5px] font-semibold text-white hover:bg-[#1a201e]"
              >
              ...
              <Link
                href="/demos"
                className="btn-press inline-flex items-center gap-2 rounded-full border border-[#0b0b0c]/15 bg-white px-6 py-3.5 text-[14.5px] font-medium text-[#0b0b0c] hover:bg-slate-50"
              >
                <Play className="h-3.5 w-3.5 fill-[#ff6a00] text-[#a84300]" />
                See Live Demos
              </Link>
            </div>
          </Reveal>
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-24 md:mb-32">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-14">
              ...
              <h2 className="mt-3 text-2xl sm:text-4xl font-semibold tracking-tight text-[#0b0b0c]">
                End-to-End Business Automation Services
              </h2>
              <p className="mt-4 text-[15px] sm:text-[16px] text-[#0b0b0c]/70">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {servicesList.map((srv, idx) => (
              <Reveal key={srv.id} delay={0.08 * idx}>
                <div className="flex h-full flex-col justify-between rounded-2xl border border-[#0b0b0c]/10 bg-white p-7 transition-all duration-300 hover:border-[#ff6a00]/40 hover:shadow-lg hover:shadow-[#ff6a00]/5">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <span className="font-mono text-sm font-semibold text-[#a84300]">
                        {srv.number}
                      </span>
                      <span className="rounded-full bg-[#fff1e6] px-2.5 py-0.5 text-[11px] font-mono font-medium text-[#a84300]">
                        Ready to Deploy
                      </span>
                    </div>

                    <h3 className="text-xl font-semibold text-[#0b0b0c]">{srv.name}</h3>
                    <p className="mt-1 text-[12.5px] font-medium text-[#a84300]">{srv.subtitle}</p>
                    <p className="mt-3 text-[14px] leading-relaxed text-[#0b0b0c]/70">{srv.desc}</p>

                    <div className="mt-5 space-y-2 border-t border-[#0b0b0c]/8 pt-4">
                      <p className="font-mono text-[11px] uppercase tracking-wider text-[#0b0b0c]/50">
                        Deliverables
                      </p>
                      {srv.deliverables.map((d) => (
                        <div key={d} className="flex items-start gap-2 text-[13px] text-[#0b0b0c]/80">
                          <CheckCircle2 className="h-3.5 w-3.5 mt-0.5 shrink-0 text-[#a84300]" />
                          <span>{d}</span>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="mt-6 border-t border-[#0b0b0c]/8 pt-4">
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {srv.tools.map((t) => (
                        <span
                          key={t}
                          className="rounded-md bg-[#f4f5f5] px-2 py-0.5 font-mono text-[10.5px] text-[#0b0b0c]/60 border border-[#0b0b0c]/8"
                        >
                          {t}
                        </span>
                      ))}
                    ...
                    <Link
                      href="/audit"
                      className="inline-flex items-center gap-1.5 text-[13.5px] font-semibold text-[#a84300] hover:underline"
                    >
        ...
        <section className="border-y border-[#0b0b0c]/10 bg-white py-16 md:py-24 mb-20 md:mb-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <Reveal>
                ...
                <div className="mt-6 space-y-4 text-[15px] sm:text-[16px] leading-relaxed text-[#0b0b0c]/75">
                  <p>
              ...
              <div className="space-y-4">
                <Reveal delay={0.1}>
                  <div className="rounded-2xl border border-[#0b0b0c]/10 bg-[#f4f5f5] p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <Zap className="h-5 w-5 text-[#a84300]" />
                      <h3 className="font-semibold text-[#0b0b0c]">Speed to Production</h3>
                    </div>
                    <p className="text-[14px] text-[#0b0b0c]/70">
                ...
                <Reveal delay={0.2}>
                  <div className="rounded-2xl border border-[#0b0b0c]/10 bg-[#f4f5f5] p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <TrendingUp className="h-5 w-5 text-[#a84300]" />
                      <h3 className="font-semibold text-[#0b0b0c]">Strict ROI Guarantees</h3>
                    </div>
                    <p className="text-[14px] text-[#0b0b0c]/70">
                      If a workflow isn&rsquo;t worth automating yet, we tell you that plainly before anything is built.
                    </p>
                  </div>
                </Reveal>
                <Reveal delay={0.3}>
                  <div className="rounded-2xl border border-[#0b0b0c]/10 bg-[#f4f5f5] p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <ShieldCheck className="h-5 w-5 text-[#a84300]" />
                      <h3 className="font-semibold text-[#0b0b0c]">Enterprise Data Privacy</h3>
                    </div>
                    <p className="text-[14px] text-[#0b0b0c]/70">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {serviceFaqs.map((faq, i) => (
              <Reveal key={faq.q} delay={0.08 * i}>
                <div className="rounded-2xl border border-[#0b0b0c]/10 bg-white p-6 sm:p-7 shadow-2xs">
                  <h3 className="text-base sm:text-lg font-semibold text-[#0b0b0c]">{faq.q}</h3>
                  <p className="mt-3 text-[14.5px] leading-relaxed text-[#0b0b0c]/70">{faq.a}</p>
                </div>
              </Reveal>
            ))}
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="rounded-3xl bg-[#0b0b0c] p-8 sm:p-12 md:p-16 text-white text-center">
              ...
              <p className="mt-4 max-w-xl mx-auto text-base sm:text-lg text-white/70">
                Claim a free 30-minute automation audit. We&rsquo;ll map your repetitive workflows and estimate what&rsquo;s at stake.
              </p>

              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/audit"
                  className="btn-press group inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-[15px] font-semibold text-[#0b0b0c] hover:bg-[#fff1e6]"
                >
                  Book Free Automation Audit
                  <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                </Link>
