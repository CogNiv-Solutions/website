...
export function generateSeoJsonLd() {
  const organizationSchema = {
    ...
    name: SITE.name,
    legalName: "Cogniv Solutions",
    alternateName: ["Cogniv", "Cogniv Solutions India", "Cogniv Automation"],
    url: SITE.url,
    logo: {
      "@type": "ImageObject",
    ...
    sameAs: [
      "https://github.com/CogNiv-Solutions",
      "https://twitter.com/cognivsolutions",
      "https://www.linkedin.com/company/cogniv-solutions",
    ],
    priceRange: "$$",
  ...
  const websiteSchema = {
    ...
    alternateName: ["Cogniv", "Cogniv Solutions India", "CognivSolutions"],
    description: SITE.description,
    publisher: {
      "@id": `${SITE.url}/#organization`,
    },
    ...
    itemListElement: [
      {
        ...
        description: "Bespoke business automation services, WhatsApp bots, and CRM systems",
      ...
      },
      {
        ...
        position: 2,
        name: "AI Solutions",
        description: "Intelligent workflow automation and AI business systems",
