              ...
              <article className="flex h-full flex-col justify-between rounded-[1.3rem] border border-[#0b0e0d]/10 bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:border-[#ea580c]/40 hover:card-shadow">
                <div>
                  <div className="flex items-center gap-3">
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-[#fff7ed] text-[#ea580c]">
                  ...
                  <div className="mt-3 rounded-xl bg-[#fafaf9] border border-[#0b0e0d]/6 p-2.5">
                    ...
                    <p className="mt-1 font-mono text-[11.5px] font-medium text-[#ea580c] leading-relaxed">
                      {ind.example}
                    </p>
                  </div>
                ...
                <div className="mt-4 border-t border-[#0b0e0d]/6 pt-3 space-y-2">
                  <button
                    ...
                    className="btn-press group inline-flex w-full items-center justify-between rounded-xl border border-[#ea580c]/20 bg-[#fff7ed] px-3.5 py-2 text-[12.5px] font-semibold text-[#c2410c] transition-all hover:border-[#ea580c] hover:bg-[#ea580c] hover:text-white"
                  >
