...
const AVAILABLE_TOOLS: ToolItem[] = [
  ...
  { id: "tally", name: "Tally Prime / ERP", category: "Accounting & Tax", icon: FileSpreadsheet, color: "text-orange-600" },
  { id: "excel", name: "Excel & Sheets", category: "Spreadsheets", icon: Table, color: "text-orange-600" },
          ...
          <div className="rounded-[1.75rem] border border-[#0b0e0d]/10 bg-[#fafaf9] p-6 card-shadow md:p-8">
            ...
            <div className="mt-8 rounded-2xl border border-[#0b0e0d]/10 bg-white p-6">
              <div className="flex items-center gap-2 text-[14px] font-semibold text-[#0b0e0d]">
                <Zap className="h-4.5 w-4.5 text-[#ea580c]" aria-hidden />
                <span>
              ...
              {activePipelines.length > 0 ? (
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {activePipelines.map((pipe) => (
                    <div
                      key={pipe.title}
                      className="flex flex-col justify-between rounded-xl border border-orange-500/20 bg-orange-50/20 p-4 transition-all hover:border-orange-500/40 hover:bg-orange-50/40"
                    >
                      <div>
                        <span className="inline-block rounded-md bg-orange-100/80 px-2 py-0.5 font-mono text-[10.5px] font-semibold text-[#ea580c]">
                          {pipe.tag}
                        </span>
              ...
              <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-[#0b0e0d]/8 pt-5 sm:flex-row">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <a
                    ...
                    className="btn-press inline-flex items-center gap-2 rounded-full border border-orange-600/30 bg-orange-50 px-4 py-2 text-[13px] font-medium text-orange-950 hover:bg-orange-100"
                  >
                    <MessageCircle className="h-3.5 w-3.5 text-orange-600" aria-hidden />
                    Chat on WhatsApp
                  </a>
                  <button
                    type="button"
            ...
            <div className="mt-8 border-t border-[#0b0e0d]/8 pt-5">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                {[
                  ...
                  >
                    <Sparkles className="h-3 w-3 text-[#ea580c]" aria-hidden />
                    {proto}
                  </span>
                ))}
              </div>
