    ...
    <section aria-labelledby="find-h" className="border-t border-[#0b0e0d]/8">
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
        ...
        <Stagger className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-5 lg:gap-3">
          {discoverSteps.map((s) => (
            <StaggerItem key={s.n}>
              <article className="group flex h-full flex-col rounded-[1.4rem] border border-[#0b0e0d]/10 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#0e7c5b]/30 hover:card-shadow">
                <p className="font-mono text-[12px] font-semibold tracking-[0.18em] text-[#0e7c5b]">{s.n}</p>
                ...
                <span className="mt-auto block pt-5" aria-hidden>
                  <span className="block h-1 overflow-hidden rounded-full bg-[#0b0e0d]/8">
                    <span className="block h-full w-0 rounded-full bg-[#0e7c5b] transition-all duration-500 group-hover:w-full" />
                  </span>
                </span>
              </article>
            </StaggerItem>
